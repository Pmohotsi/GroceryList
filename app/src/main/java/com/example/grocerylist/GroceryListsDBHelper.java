...
public class GroceryListsDBHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME ="grocerylists.db";
    public static final int DATABASE_VERSION = 1;
    public GroceryListsDBHelper(@Nullable Context context) {
